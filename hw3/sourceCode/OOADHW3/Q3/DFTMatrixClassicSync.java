 ...
 * Basic synchronization mechanisms such as wait(),
 * notify(), notifyall() are used for synchronization.
 * <p>
 * The following sites were used for the algorithm.
 * https://github.com/TTrojanovich/2D_Discrete_Fourier
 * https://www.nayuki.io/page/how-to-implement-the-discrete-fourier-transform
 */
public class DFTMatrixClassicSync implements Runnable {
    ...
    private final List<String> _sync;
     ...
     */
    public DFTMatrixClassicSync(Complex[][] mat1, Complex[][] mat2, int x0, int y0, int x1, int y1, int N, List<String> sync, int threadSize) {
        this._mat1 = mat1;
        this._mat2 = mat2;
        this._x0 = x0;
        this._y0 = y0;
    ...
    public void run() {
        ...
        sum();
        _sync.add(this.toString());


        synchronized (_sync) {
            while (_sync.size() < _threadSize) {
                try {
